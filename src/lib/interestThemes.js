...
const FALLBACK_THEME_PRESETS = [
  {
    ...
    matchers: ['fire', 'firefighter', 'firefighters', 'fireman', 'pompier', 'rescue', 'ladder', 'ember', 'engine'],
    icons: ['🚒', '🧯', '🔥', '🚨', '🪓'],
    swatches: [
  ...
  },
  {
    ...
    swatches: [
      ...
      { bg: '#ecfeff', border: '#22d3ee', text: '#0e7490', shadow: '0 10px 22px rgba(34,211,238,0.18)' },
      { bg: '#fef2f2', border: '#ef4444', text: '#991b1b', shadow: '0 10px 22px rgba(239,68,68,0.18)' },
    ],
    source: 'fallback-preset',
  },
  {
  ...
  },
  {
    key: 'fantasy-magic',
    label: 'Fantasy & Magic',
    matchers: ['fantasy', 'magic', 'dragon', 'wizard', 'castle', 'knight', 'fairy'],
    icons: ['🐉', '🪄', '🏰', '🧙', '🧚'],
    swatches: [
      { bg: '#f5f3ff', border: '#8b5cf6', text: '#5b21b6', shadow: '0 10px 20px rgba(139,92,246,0.2)' },
      { bg: '#e0e7ff', border: '#6366f1', text: '#312e81', shadow: '0 12px 24px rgba(99,102,241,0.2)' },
    ],
    source: 'fallback-preset',
  },
  {
...
const ADDITIONAL_ICON_CATALOG = [
  ...
  { matchers: ['superhero', 'hero', 'villain', 'power'], icons: ['🦸', '🦹', '💥', '⚡', '🛡️'], palette: { hue: 0 } },
  { matchers: ['pirate', 'pirati', 'treasure', 'ship'], icons: ['🏴‍☠️', '⚓', '💎', '🗺️', '🦜'], palette: { hue: 210 } },
  { matchers: ['art', 'paint', 'creativity', 'draw', 'design'], icons: ['🎨', '🖌️', '✏️', '🎭', '🖼️'], palette: { hue: 330 } },
  { matchers: ['mystery', 'detective', 'clue', 'spy'], icons: ['🕵️', '🔎', '🧩', '🤫', '🕴️'], palette: { hue: 240 } },
  {
    matchers: ['tailor', 'tailors', 'sew', 'sewing', 'seamstress', 'croitor', 'croitoare', 'stitch', 'fashion'],
    icons: ['🧵', '🪡', '✂️', '🧷', '👗'],
    palette: { hue: 340 },
  },
  {
    matchers: ['priest', 'priests', 'preot', 'preoti', 'bible', 'biblie', 'church', 'faith', 'chapel'],
    icons: ['📖', '✝️', '⛪', '🕯️', '🙏'],
    palette: { hue: 45 },
  },
];
